...
const SideBar = ({ expand, setExpand }) => {
  ...
  return (
    <div
      className={`flex flex-col justify-between pt-7 transition-all z-59 max-md:absolute max-md:h-screen bg-[#212327] ${
      ...
      <div>
        ...
        >
          ...
          >
            ...
            />
            <div className={`absolute w-max ${expand ? 'left-1/2 -translate-1/2 top-12':'-top-12 left-0'} opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none `}>
